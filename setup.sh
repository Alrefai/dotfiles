...
if ! command -v nix >/dev/null; then
  ...
  if [[ -e /etc/NIXOS ]]; then
    ...
    sudo nixos-rebuild switch --flake github:alrefai/dotfiles/switch-to-lix#nixos --impure
  else
...
nix run home-manager/master -- switch -b bak --flake github:alrefai/dotfiles/switch-to-lix
