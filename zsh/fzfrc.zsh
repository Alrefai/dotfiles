...
export FZF_ALT_C_COMMAND="bfs -type d -nohidden -not -path '*/node_modules/*'"
...
export FZF_DEFAULT_COMMAND='rg --files --no-ignore --hidden --follow -g "!{.git,node_modules,*.swp,dist,*.coffee,dotbot,.next}/*" 2> /dev/null'
